    ...
    <div className="bg-teal-500 min-h-screen rounded-xl flex items-center justify-center">
      <div className="max-w-md mx-auto p-8 bg-white rounded-lg shadow-lg">
        ...
        <Link href="/auth/login">
          <button className="bg-orange-500 block my-2 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded mx-auto">
            Get Started
          </button>
        </Link>
        <Link href="/manifest">
          <button className="bg-orange-500 block hover:bg-orange-600 text-white font-bold py-2 px-4 rounded mx-auto">
            Read our Manifest
          </button>
        </Link>
      </div>
